    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      {{-- <li class="nav-item">
        ...
        <ul id="setup-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('admin.setup.designation.index') }}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#bank-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>User</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="bank-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
          ...
          {{-- <li>
            <a href="{{ route('admin.user.transactions') }}">
              <i class="bi bi-circle"></i><span>User Transactions</span>
            </a>
          </li> --}}
        </ul>
      </li>
