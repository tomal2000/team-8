...
@include('layouts.pub.header')
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-outline-secondary">
                <div class="card-body">
                    <h3 class="text-center">অনলাইন রেজিস্ট্রেশন</h3>
                ...
                {{-- <div >
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ route('booking',$programme->id) }}" class="btn btn-primary">আবেদন করুন</a>
                    </div>
                    <div class="card-footer text-body-secondary">
                      {{ 'রেজিস্ট্রেশন শুরু '. bangla_date(\Carbon\Carbon::parse($programme->start_at)->timestamp,"en"). ' থেকে ' .bangla_date(\Carbon\Carbon::parse($programme->end_at)->timestamp,"en"). ' তারিখ পর্যন্ত' }}
                    </div>
                  </div>
                    @endforeach
